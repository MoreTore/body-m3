...
void board_detect(void) {
  ...
  if (hw_type == HW_TYPE_BASE) {
    board.hall_left.hall_portA = GPIOB;
    board.hall_left.hall_pinA = GPIO_PIN_5;
    board.hall_left.hall_portB = GPIOB;
    board.hall_left.hall_pinB = GPIO_PIN_6;
    board.hall_left.hall_portC = GPIOB;
    board.hall_left.hall_pinC = GPIO_PIN_7;
